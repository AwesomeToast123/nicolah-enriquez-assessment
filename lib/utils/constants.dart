...
const blankText = '';
const dialogHeaderText = "Error Text";
const errorTextDialog = "Please complete the form";
const okText = "Ok";
...
const double dialogRadiusValue = 5;
...
const double heightTextStyleDialog = 2;
const double heightContainerSizeDialog = 70;